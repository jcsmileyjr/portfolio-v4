        ...
        <section className="bg-primaryBlue w-full text-white py-4 px-8 flex flex-col lg:flex-row justify-between mb-8">
            <div className='flex flex-row justify-between'>
                <div className='flex flex-row gap-4 items-center '>
                    ...
                    {/* LinkedIn Link */}
                    <Link className='hover:scale-150' href="https://www.linkedin.com/in/jcsmileyjr/" rel="noopener" target="_blank">
                    ...
                    {/* Twitter Link */}
                    <Link className='hover:scale-150' href="https://twitter.com/JCSmiley4" rel="noopener" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    ...
                    {/* GitHub Link */}
                    <Link className='hover:scale-150' href="https://github.com/jcsmileyjr" rel="noopener" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    ...
                    <Link className='hover:scale-150' href="https://dev.to/jcsmileyjr" rel="noopener" target="_blank">
