...
const Header = () => {
    return (
        <section className="bg-primaryBlue w-full text-white py-4 px-8 flex flex-row justify-between">
            <div className='flex flex-row gap-4 items-center '>
                <Image priority={false} src={Coder} width={75} height={50} alt="" className='h-16 ml-16' />
                <Link href="/">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <Link href="/">
                    <Image priority={false} src={Devto} width={15} height={5} alt="" className='h-4' />            
                </Link>
            </div>
            <div className='flex flex-row gap-4 mr-16 items-center'>
