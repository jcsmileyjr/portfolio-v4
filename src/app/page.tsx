        ...
        <section className='w-full md:w-3/4'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 gap-2 mb-4 md:ml-4 lg:grid-cols-4 xl:grid-cols-6'>
            <div className='flex flex-row justify-center1 ml-6 md:ml-0'>
              <input className={`${technologies === "All" ? "bg-primaryBlue" : ""} appearance-none focus:bg-primaryBlue rounded-full w-6 h-6 border-2 border-solid border-primaryBlue`} type="radio" id="All" name="technologies" value="All" checked={technologies === "All"} onChange={(e) => setTechnologies(e.target.value)} />
